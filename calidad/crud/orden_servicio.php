				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="#" class="logo"><strong>Orden de Servicio - In Hole Solutions</strong> </a>
									<ul class="icons">
										
										<li><a href="#" class="icon fa-times-circle"><span class="label"><a href="../php/cerrar_sesion.php">Cerrar Session</a></span></a></li>
									</ul>
								</header>
						...
						<div class="inner">
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										<li><a href="../php/bienvenida.php">Home</a></li>
